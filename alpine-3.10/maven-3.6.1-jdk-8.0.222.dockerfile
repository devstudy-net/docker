# Build:
# docker build -t devstudy/maven:jdk8 -f ./maven-3.6.1-jdk-8.0.222.dockerfile .
#
# Push:
# docker push devstudy/maven:jdk8
#
# Usage:
# cd ~/my-project
# docker run -v ~/:/home/mvn/ -it --rm -u 1000 -e MAVEN_CONFIG=/home/mvn/.m2 -v "$PWD":/opt/src/ -w /opt/src devstudy/maven:jdk8 mvn -Duser.home=/home/mvn clean install site
#
# Versions:
# ----------------------------------------------------------------------------------------------------------------
